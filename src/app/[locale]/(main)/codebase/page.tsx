...
import { healthCheckApi } from '@/apis/shared.api';
...
import { NOT_FOUND_PAGE } from '@/constants/route-pages.const';
import { NODE_ENVS, SELECTORS } from '@/constants/shared.const';
    ...
    <div className={styles['container']}>
      ...
      <section>
        ...
        <div className=" flex  gap-2  mb-4">
          <BaseButton
            icon={
              <IconSearch fill={DEFAULT_THEME.WHITE} height="14" width="14" />
            }
            onClick={handleClickButton}
            shape="circle"
          />
          <BaseButton
            colorText="blue"
            icon={
              <IconSettings fill={DEFAULT_THEME.WHITE} height="14" width="14" />
            }
            onClick={handleClickButton}
            shape="circle"
            variant="solid"
          ...
          <BaseButton
            colorText="danger"
            icon={
              <IconDelete fill={DEFAULT_THEME.WHITE} height="14" width="14" />
            }
            onClick={handleClickButton}
            shape="circle"
            variant="solid"
